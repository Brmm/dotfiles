...
sudo scutil --set ComputerName "Brmm"
sudo scutil --set HostName "Brmm"
sudo scutil --set LocalHostName "Brmm"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Brmm"
...
## Note: changing the speed of auto-hiding doesn't work in Catalina anymore
...
# Disable the “Are you sure you want to open this file?” Warning Dialog
